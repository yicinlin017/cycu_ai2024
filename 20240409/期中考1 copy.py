...
#讀取/workspaces/cycu_ai2024/20240409/地震活動彙整_638482848123192524.csv 並顯示出地震時間2024/04/03之後的資料
...
with open('/workspaces/cycu_ai2024/20240409/地震活動彙整_638482848123192524.csv', 'wb') as f:
 ...
 #讀取CSV檔案
df = pd.read_csv('/workspaces/cycu_ai2024/20240409/地震活動彙整_638482848123192524.csv', encoding='utf-8', header=1)

# 過濾出地震時間2024/04/03之後的資料
#df['地震時間'] = pd.to_datetime(df['地震時間'])
#df = df[df['地震時間'] > datetime(2024, 4, 3)]
